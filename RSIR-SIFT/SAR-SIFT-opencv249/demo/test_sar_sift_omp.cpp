...
void test_sar_sift_omp(){
    ...
    */
    /*------------------------------------------test2: 特征匹配例子------------------------------------------*/
    string change_model = string("similarity");// 注: 图像变换方式: 还可以是perspective similarity
	...
	std::cout << "sar_sift_1 image1 total time: "<< (detect1_time + des1_time) << "s" << std::endl;
	...
	std::cout << "Standard sift image1 total time: "<< (t1_0 + t1_1) << "s" << std::endl;
	std::cout << "Standard sift / sar_sift "<< (t1_0 + t1_1)/(detect1_time + des1_time) << std::endl;
	...
	std::cout << "sar_sift_1 image2 detect time: " << detect2_time << "s, keypoints_2:" << keypoints_2.size() << std::endl;
	...
	std::cout << "sar_sift_1 image2 compute time: " << des2_time << "s" << std::endl;
	std::cout << "sar_sift_1 image1 total time: "<< (detect2_time + des2_time) << "s" << std::endl;
	...
	std::cout << "Standard sift image2 total time: "<< (t2_0 + t2_1) << "s" << std::endl;
	std::cout << "Standard sift / sar_sift "<< (t2_0 + t2_1)/(detect2_time + des2_time) << std::endl;
